...
The following variables were removed because they directly contribute to the outcome variable:
-medal_Efficiency, -awards_gold, -awards_bronze, -awards_silver, -awards_honorable_mentions, -total_score, -p1, -p2, -p3, -p4, -p5, -p6.

The following variables were removed because they are categorical:
-country, -p7, -leader, -deputy_leader, -Country Code, -Region, -Income Group.
